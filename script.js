...
const I18N = {
  en: {
    ...
    "about.exp1": "AWS DevOps Engineer — Omnisource (Contractor), 2025–present (Timisoara, Romania)",
  ...
  ro: {
    ...
    "about.exp1": "AWS DevOps Engineer — Omnisource (Contractor), 2025–prezent (Timisoara, România)",
